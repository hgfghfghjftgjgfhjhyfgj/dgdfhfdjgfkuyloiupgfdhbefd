...
client.user.setGame(`-help | Yazan AL-Harairy bot`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on('message', message=> {
  if(message.content.startsWith('-uptime')) { //ALPHA CODES
...
client.on("guildMemberAdd", member => {
  ...
  return channel.send(`**Welcome To Trees Server**
[ في حال حاب تلعب اي لعبه وتبي تشوف رومات اللعبه توجه الي الروم  وا اول ما تاخذ الرتبه تنفك لك رومات اللعبه الي انت اخذت رتبتها]
**__الروم حق الالعاب__** **:** <#512578087309803543>
...
if(!message.channel.guild) return;
  ...
  const days = millis / 1000 / 60 / 60 / 24;
            dateFormat(now, 'dddd, mmmm dS, yyyy');
                          ...
                          //دخولك الديسكورد
                          var day = `${days.toFixed(0)} day Ago`
  ...
  const days1 = millis1 / 1000 / 60 / 60 / 24;
                        ...
                        //دخولك السيرفر
                        var day2 = `${days1.toFixed(0)} day Ago`
                        ctx.font = '27px Arial Bold';
                        ctx.fontSize = '20px';
                        ctx.fillStyle = "#ffffff";
                        ctx.textAlign = "center";
...
client.on('message', message => {
  if (message.content === '-colors') {
      if (!message.channel.guild) return;
    message.channel.sendFile('https://cdn.discordapp.com/attachments/472743324084731914/478685035730305036/color.png');
  }
...
client.on('ready',async () => {
    var ch = "585238586136199265";
    var gu = "556806966597648388";
    var currentTime = new Date(),
            Year = currentTime.getFullYear(),
            Month = currentTime.getMonth() + 1,
            Day = currentTime.getDate()
 client.guilds.get(gu).channels.get(ch).setName(`Date : ${Year}/${Month}/${Day}`).then(h => {
    setInterval(() => {
      h.setName(`Date : ${Year}/${Month}/${Day}`)
    },1000);
  });
});
...
if(ReBeL.voiceChannelID !== "585238301590683650") return console.log("أيرور . ");
ReBeL.guild.createChannel(ReBeL.user.username , 'voice').then((rebeeel) =>{
    rebeeel.setParent("585238301590683650");
...
const w = ['./w.png'];
      ...
      ctx.fillText(``, 240, 90);
                       ...
                       ctx.font = '30px kathen';
                              ctx.fontSize = '25px';
                              ctx.fillStyle = "#FFFFFF";
                                ctx.fillText(member.user.username, 240, 170);
...
client.on("ready", () => {
    var guild;
    while (!guild)
        guild = client.guilds.get("556806966597648388");
...
client.on("guildMemberAdd", (member) => {
    let channel = member.guild.channels.get("585237170520981514");
    if (!channel) {
